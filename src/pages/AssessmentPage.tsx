    ...
    return (
        <div
            ...
            style={{
                ...
                backgroundColor: `${mode.accentColor}05`,
            }}
    ...
    return (
        <div className="space-y-2">
            {files.map((file) => (
                <div
                    key={file.id}
                    className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all group"
                >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {isLoading && (
                <div className="flex gap-3">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-2xl px-4 py-2.5 border shadow-sm" style={{ borderColor: `${mode.accentColor}25` }}>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 p-4 bg-white dark:bg-gray-950">
            <div className="flex gap-2 items-center">
                <input
                    ...
                    className="flex-1 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-2.5 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-1 transition-all"
                    style={{
    ...
    if (!selectedDocType) {
        return (
            <div className="text-center py-6">
                <FileOutput className="h-8 w-8 mx-auto text-gray-400 mb-2" />
                <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="space-y-3">
            <div className="p-3 rounded-xl" style={{ backgroundColor: `${mode.accentColor}10` }}>
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                        <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">Selecionado</p>
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm focus:outline-none focus:ring-1 transition-all"
                    onFocus={(e) => e.currentTarget.style.borderColor = mode.accentColor}
                    onBlur={(e) => e.currentTarget.style.borderColor = ''}
                />
            </div>
...
const AssessmentContent: React.FC = () => {
    ...
    return (
        <div className="h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
            {/* Top Bar - Altura normal (56px) */}
            <header className="flex items-center justify-between h-14 px-6 border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl flex-shrink-0">
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={toggleMode}
                        className="text-xs px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex items-center gap-1.5"
                    >
                        {getModeIcon()}
                        {mode.name}
                    </button>
            ...
            {/* 3-Column Layout - NotebookLM Style */}
            <div className="flex flex-1 overflow-hidden">
                {/* LEFT PANEL - Files - 280px */}
                <div className="w-[280px] border-r border-gray-200 dark:border-gray-800 flex flex-col bg-white/40 dark:bg-gray-950/40 flex-shrink-0">
                ...
                {/* CENTER PANEL - Chat - Flexível */}
                <div className="flex-1 flex flex-col bg-white/30 dark:bg-gray-950/30 min-w-0">
                    <ChatMessages />
                    <ChatInput />
                </div>

                {/* RIGHT PANEL - Studio - 300px */}
                <div className="w-[300px] border-l border-gray-200 dark:border-gray-800 flex flex-col bg-white/40 dark:bg-gray-950/40 flex-shrink-0">
                    <div className="p-4 border-b border-gray-200 dark:border-gray-800">
            ...
            <div className="h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950">
                <div className="text-center">
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-sm rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:bg-gray-800 transition-colors"
                    >
                        Voltar para Home
                    </button>
                </div>
